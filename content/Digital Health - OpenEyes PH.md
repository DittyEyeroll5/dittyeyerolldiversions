...
I've had my fair share of using local EMRs which allow ophthalmologists to work with them but given their text based entries, it doesn't allow for searching for a specific finding or filtering for specific diseases. That's why I went around online and found this software:
# OpenEyes
...
## Open Invitation
I am no software developer. While I have aspired to be one, I have neither the energy or time to reverse engineer the source code on my own. I am posting my [[OpenEyes Localization Journey|learning journey]] online in the hopes of getting more eyes on this project and helping it reach fruition.
