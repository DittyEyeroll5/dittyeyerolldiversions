...
OpenEyes is an open-source EMR created with the ophthalmologist in mind, allowing for rapid entry of data, while providing interactive illustrations which are adapted to the way eye doctors document their findings.
